...
module.exports = {
    ...
    search: async function (req, res) {
        ...
        const qEstate = req.body.estate || "";
        const qBedrooms = parseInt(req.body.bedrooms) || "0";
        const qGrossareaMin = parseInt(req.body.grossarea) || "0";
        const qGrossareaMax = parseInt(req.body.grossarea) || "99999";
        const qRentMin = parseInt(req.body.rent) || "0";
        const qRentMax = parseInt(req.body.rent) || "99999" ;
